      ...
      <div className="relative bg-[#0d1b3e] text-white px-6 py-16 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            <span className="text-xs font-bold tracking-widest uppercase text-white">Account</span>
          </motion.div>
            ...
            >
              {[
                ...
                <motion.div key={i} whileHover={{ scale: 1.04 }}
                  className="bg-white/10 hover:bg-white/15 border border-white/20 text-white rounded-2xl px-5 py-4 flex items-center gap-3 cursor-default transition-all"
                >
                  <div className="w-8 h-8 rounded-xl bg-white/10 flex items-center justify-center text-white">{s.icon}</div>
                  <div>
